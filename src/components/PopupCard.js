...
const PopupCard = () => {
  ...
  return (
    <div className=" absolute bottom-10  bg-red-600  hidden rounded-full left-3  ">
      <button onClick={onShow} className="h-[40px] w-[40px]">
        <FormatItalicIcon />
      </button>
      {show ? (
        <div className=" w-[250px] rounded-md block bg-white  md:hidden border-black p-3 absolute bottom-[100%] left-8">
